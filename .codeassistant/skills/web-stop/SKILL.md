...
```powershell
python ".codeassistant/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".codeassistant/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".codeassistant/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
