...
```powershell
powershell.exe -NoProfile -File ".codeassistant/skills/template-remove/scripts/remove-template.ps1" -ObjectName "<ObjectName>" -TemplateName "<TemplateName>" [-SrcDir "<SrcDir>"]
```
