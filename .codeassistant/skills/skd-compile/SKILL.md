...
```powershell
# Из файла
python ".codeassistant/skills/skd-compile/scripts/skd-compile.py" -DefinitionFile "<json>" -OutputPath "<Template.xml>"

# Из строки (без промежуточного файла)
python ".codeassistant/skills/skd-compile/scripts/skd-compile.py" -Value '<json-string>' -OutputPath "<Template.xml>"
```
