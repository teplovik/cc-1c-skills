...
```powershell
python ".codeassistant/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".codeassistant/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".codeassistant/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".codeassistant/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
