...
Автоматическая сборка из [main](https://github.com/teplovik/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Yandex Code Assistant** с рантаймом **PowerShell**.
