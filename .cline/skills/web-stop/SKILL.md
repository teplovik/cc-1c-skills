...
```powershell
python ".cline/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".cline/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".cline/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
