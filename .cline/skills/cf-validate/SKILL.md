...
```powershell
python ".cline/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty"
python ".cline/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty/Configuration.xml"
```
