...
```powershell
python ".cline/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".cline/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".cline/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".cline/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
