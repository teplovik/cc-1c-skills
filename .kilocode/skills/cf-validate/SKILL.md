...
```powershell
python ".kilocode/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty"
python ".kilocode/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty/Configuration.xml"
```
