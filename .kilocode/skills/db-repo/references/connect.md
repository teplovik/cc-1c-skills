...
```powershell
powershell.exe -NoProfile -File ".kilocode/skills/db-repo/scripts/db-repo.ps1" -Command connect -InfoBasePath "C:\Bases\MyDB" -RepositoryPath "\\srv01\repo\MyApp" -RepositoryUser "Ivanov" -RepositoryPassword "…"
```
...
```powershell
powershell.exe -NoProfile -File ".kilocode/skills/db-repo/scripts/db-repo.ps1" -Command disconnect -InfoBasePath "C:\Bases\MyDB"
```
