...
```powershell
python ".kilocode/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".kilocode/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".kilocode/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
