...
```powershell
python ".kilocode/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".kilocode/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".kilocode/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".kilocode/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
