...
```powershell
python ".gemini/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".gemini/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".gemini/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
