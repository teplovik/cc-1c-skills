...
```powershell
python ".gemini/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".gemini/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".gemini/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".gemini/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
