...
```powershell
python ".cursor/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty"
python ".cursor/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty/Configuration.xml"
```
