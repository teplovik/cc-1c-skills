...
```powershell
python ".cursor/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".cursor/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".cursor/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
