...
```powershell
python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
