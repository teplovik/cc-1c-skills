...
```powershell
python ".github/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".github/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".github/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
