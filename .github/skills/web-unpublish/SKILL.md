...
```powershell
python ".github/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".github/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".github/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".github/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
