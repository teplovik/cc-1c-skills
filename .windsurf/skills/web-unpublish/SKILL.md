...
```powershell
python ".windsurf/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".windsurf/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".windsurf/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".windsurf/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
