...
```powershell
python ".windsurf/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".windsurf/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".windsurf/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
