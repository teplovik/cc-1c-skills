...
```powershell
python ".windsurf/skills/db-repo/scripts/db-repo.py" -Command set-label -InfoBasePath "C:\Bases\MyDB" -Label "Релиз 1.2" -Version 120 -Comment "Передано в тест"
```
...
```powershell
python ".windsurf/skills/db-repo/scripts/db-repo.py" -Command optimize -InfoBasePath "C:\Bases\MyDB"
```
...
```powershell
python ".windsurf/skills/db-repo/scripts/db-repo.py" -Command clear-cache -InfoBasePath "C:\Bases\MyDB" -CacheScope local
```
