...
```powershell
powershell.exe -NoProfile -File ".kiro/skills/db-repo/scripts/db-repo.ps1" -Command report -InfoBasePath "C:\Bases\MyDB" -OutputFile "C:\tmp\repo.txt"
```
...
```powershell
powershell.exe -NoProfile -File ".kiro/skills/db-repo/scripts/db-repo.ps1" -Command dump-cfg -InfoBasePath "C:\Bases\MyDB" -OutputFile "C:\tmp\v120.cf" -Version 120
```
