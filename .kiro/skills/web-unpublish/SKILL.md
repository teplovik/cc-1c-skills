...
```powershell
python ".kiro/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".kiro/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".kiro/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".kiro/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
