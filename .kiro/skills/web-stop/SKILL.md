...
```powershell
python ".kiro/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".kiro/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".kiro/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
