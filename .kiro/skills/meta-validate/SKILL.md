...
```powershell
python ".kiro/skills/meta-validate/scripts/meta-validate.py" -ObjectPath "Catalogs/Номенклатура/Номенклатура.xml"
python ".kiro/skills/meta-validate/scripts/meta-validate.py" -ObjectPath "Catalogs/Банки|Documents/Заказ"
```
