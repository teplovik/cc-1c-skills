...
```powershell
python ".opencode/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".opencode/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".opencode/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".opencode/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
