...
```powershell
python ".opencode/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".opencode/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".opencode/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
