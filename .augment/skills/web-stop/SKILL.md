...
```powershell
python ".augment/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".augment/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".augment/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
