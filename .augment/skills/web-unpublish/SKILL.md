...
```powershell
python ".augment/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".augment/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".augment/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".augment/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
