...
```powershell
python ".roo/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".roo/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".roo/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
