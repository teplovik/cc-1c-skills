...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/template-remove/scripts/remove-template.ps1" -ObjectName "<ObjectName>" -TemplateName "<TemplateName>" [-SrcDir "<SrcDir>"]
```
