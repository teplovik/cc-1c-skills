...
```powershell
python ".codex/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
python ".codex/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
python ".codex/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
python ".codex/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
