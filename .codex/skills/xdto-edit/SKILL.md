...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/xdto-edit/scripts/xdto-edit.ps1" -PackagePath "<путь>" -Operation <op> -Target "<адрес>" -Value "<значение>"
```
