...
```powershell
python ".codex/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```powershell
# Остановить Apache
python ".codex/skills/web-stop/scripts/web-stop.py"

# С указанием пути
python ".codex/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
