...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/subsystem-edit/scripts/subsystem-edit.ps1" -SubsystemPath '<path>' -Operation add-content -Value 'Catalog.Товары'
```
