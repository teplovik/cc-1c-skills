...
```powershell
python ".codex/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty"
python ".codex/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty/Configuration.xml"
```
