...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/skd-decompile/scripts/skd-decompile.ps1" -TemplatePath "<Template.xml>" -OutputPath "<out.json>"
```
