...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/xdto-compile/scripts/xdto-compile.ps1" -XsdPath "<схема.xsd>" -OutputDir "<каталог-исходников>"
```
